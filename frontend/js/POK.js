...
export class POK {
    ...
    async initFS() {
        ...
        //if the request thing ever fails

        request.onerror = (e) => {
            console.error(`ERR ${e.target.error?.message}`); };
        //can be used for forced updates to paperOS. Might be a bit of an issue for existing databases though... TBD
