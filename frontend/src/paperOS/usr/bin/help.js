...
ls [OPTIONAL location]: lists all folders and files in the working directory. When given location, it will display the contents of the working directory + the location directory.
